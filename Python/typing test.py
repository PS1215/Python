...
def game(): 
	...
	x2.place(x=150, y=10) 
	x3 = Label(windows, text="Start Typing here", font="times 20") 
	x3.place(x=10, y=50) 
	...
	b3 = Button(windows, text="Try Again", 
				command=game, width=12, bg='red') 
	b3.place(x=250, y=100) 
	windows.mainloop() 


x1 = Label(window, text="Welcome to the Piyush Singh typing show.....", font="times 20") 
x1.place(x=10, y=50) 

b1 = Button(window, text="Go", command=game, width=12, bg='green') 
